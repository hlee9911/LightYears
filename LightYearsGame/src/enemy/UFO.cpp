...
namespace ly
{
	UFO::UFO(World* owningWorld, const sf::Vector2f& velocity, const std::string& texturePath, float rotatingSpeed) noexcept
		...
		m_Shooter0{ new BulletShooter{this, 0.5f, sf::Vector2f{0.0f, 0.0f}, -60.0f} },
		m_Shooter1{ new BulletShooter{this, 0.5f, sf::Vector2f{0.0f, 0.0f}, 60.0f} },
		m_Shooter2{ new BulletShooter{this, 0.5f, sf::Vector2f{0.0f, 0.0f}, 180.0f} },
