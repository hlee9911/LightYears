...
namespace ly
{
	FrontalWiper::FrontalWiper(Actor* owner, float cooldownTime, const sf::Vector2f& localOffset, float width) noexcept
		...
		m_Shooter4{ owner, 0.1f, {localOffset.x, localOffset.y + width / 1.5f}, 10.0f, "SpaceShooterRedux/PNG/Lasers/laserBlue07.png" },
		m_Shooter5{ owner, 0.1f, {localOffset.x, localOffset.y - width / 1.5f}, -10.0f, "SpaceShooterRedux/PNG/Lasers/laserBlue07.png" }
	{
